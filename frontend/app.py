...
def get_db_path():
    return os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'goldbot_checkpoints.db')
...
with st.sidebar:
    ...
    st.markdown("<a href='http://localhost:8502/landing.html' target='_self' style='display:block;width:100%;text-align:center;background:linear-gradient(135deg,#B8860B,#FFD700);color:#1A1712;padding:10px;border-radius:10px;font-weight:600;font-size:0.9rem;text-decoration:none;margin-bottom:8px;'>Home</a>", unsafe_allow_html=True)
