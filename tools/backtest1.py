...
def generate_stratified_dates(start, end, n):
    total_days = (end - start).days
    step = total_days / n
    dates = []
    for i in range(n):
        offset = int(i * step + random.uniform(0, step * 0.5))
...
TEST_DATES = generate_stratified_dates(START_DATE, END_DATE, N_DATES)
