...
# ---------- 20 NEW stratified dates (non-overlapping with original 20) ----------
TEST_DATES = [
...
# ---------- Historical Tier-1 fetchers (identical to original backtest1.py) ----------
...
def build_historical_state(as_of_date):
    ...
    state = {
        ...
        "central_bank_buying": "Central Bank Gold Buying: Data unavailable (backtest - no historical text recovery)",
...
def run_backtest():
    ...
    import os
    csv_path = "backtest1_expansion_results.csv"
    ...
    print("\n" + "="*50)
    print("BACKTEST 1 EXPANSION SUMMARY (20 new dates)")
