...
def build_historical_state(as_of_date):
    ...
    state = {
        ...
        "central_bank_buying": "Central Bank Gold Buying: Data unavailable (backtest - 2008 predates GDELT/no historical text recovery attempted)",
        "geopolitical_risk": "Geopolitical Risk: Data unavailable (backtest - 2008 predates GDELT/no historical text recovery attempted)",
    }
...
def run_backtest():
    ...
    print("\n" + "="*50)
    print("BACKTEST 4 SUMMARY (2008 Financial Crisis, no GDELT)")
